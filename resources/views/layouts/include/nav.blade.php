        ...
        <div class="container">
            ...
            <div class="navbar-header">
                <span class="navbar-toggle col-6" aria-expanded="false">
                    <span ><a href="#" ><i class="fa-solid fa-circle-plus fa-xl text-white"></i></a></span>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right main-menu">
                    <li><a href="#" ><i class="fa-solid fa-circle-plus fa-xl text-white"></i></a></li>
                    <li><a href="#"><i class="fa-solid fa-house fa-xl  text-white"></i></a></li>
                    <li><a href="#"><i class="fa-solid fa-user fa-xl  text-white"></i></a></li>
                </ul>
